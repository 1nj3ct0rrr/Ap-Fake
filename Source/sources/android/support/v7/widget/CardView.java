...
public class CardView extends FrameLayout {
    ...
    private void initialize(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        float radius = a.getDimension(R.styleable.CardView_cardCornerRadius, Common.Density);
        float elevation = a.getDimension(R.styleable.CardView_cardElevation, Common.Density);
        float maxElevation = a.getDimension(R.styleable.CardView_cardMaxElevation, Common.Density);
