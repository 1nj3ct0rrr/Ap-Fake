...
public class ac_make2 extends Activity implements B4AActivity {
    ...
    public static ac_make2 mostCurrent;
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (isFirst) {
            processBA = new BA(getApplicationContext(), null, null, "b4a.example.cashss", "b4a.example.cashss.ac_make2");
            processBA.loadHtSubs(getClass());
            BALayout.setDeviceScale(getApplicationContext().getResources().getDisplayMetrics().density);
        } else if (!(previousOne == null || (activity = previousOne.get()) == null || activity == this)) {
            BA.LogInfo("Killing previous instance (ac_make2).");
            activity.finish();
        }
    ...
    static class WaitForLayout implements Runnable {
        ...
        public void run() {
            if (ac_make2.afterFirstLayout || ac_make2.mostCurrent == null) {
                return;
            }
            if (ac_make2.mostCurrent.layout.getWidth() == 0) {
                BA.handler.postDelayed(this, 5);
                return;
            }
            ac_make2.mostCurrent.layout.getLayoutParams().height = ac_make2.mostCurrent.layout.getHeight();
            ac_make2.mostCurrent.layout.getLayoutParams().width = ac_make2.mostCurrent.layout.getWidth();
            ac_make2.afterFirstLayout = true;
            ac_make2.mostCurrent.afterFirstLayout();
        }
    }
    ...
    private void afterFirstLayout() {
        if (this == mostCurrent) {
            this.activityBA = new BA(this, this.layout, processBA, "b4a.example.cashss", "b4a.example.cashss.ac_make2");
            ...
            if (BA.isShellModeRuntimeCheck(processBA)) {
                ...
                processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.cashss.ac_make2", processBA, this.activityBA, this._activity, Float.valueOf(Common.Density), mostCurrent);
                this._activity.reinitializeForShell(this.activityBA, "activity");
            }
            initializeProcessGlobals();
            initializeGlobals();
            BA.LogInfo("** Activity (ac_make2) Create, isFirst = " + isFirst + " **");
            processBA.raiseEvent2(null, true, "activity_create", false, Boolean.valueOf(isFirst));
            isFirst = false;
            if (this == mostCurrent) {
                processBA.setActivityPaused(false);
                BA.LogInfo("** Activity (ac_make2) Resume **");
    ...
    private class B4AMenuItemsClickListener implements MenuItem.OnMenuItemClickListener {
        ...
        public boolean onMenuItemClick(MenuItem menuItem) {
            ac_make2.processBA.raiseEventFromUI(menuItem.getTitle(), this.eventName + "_click", new Object[0]);
            return true;
        }
    }

    public static Class<?> getObject() {
        return ac_make2.class;
    }
    ...
    private class HandleKeyDelayed implements Runnable {
        ...
        public boolean runDirectly(int i) {
            Boolean bool = (Boolean) ac_make2.processBA.raiseEvent2(ac_make2.this._activity, false, "activity_keypress", false, Integer.valueOf(i));
    ...
    public void onPause() {
        ...
        if (this._activity != null) {
            Msgbox.dismiss(true);
            BA.LogInfo("** Activity (ac_make2) Pause, UserClosed = " + this.activityBA.activity.isFinishing() + " **");
    ...
    private static class ResumeMessage implements Runnable {
        ...
        public void run() {
            if (ac_make2.mostCurrent != null && ac_make2.mostCurrent == this.activity.get()) {
                ac_make2.processBA.setActivityPaused(false);
                BA.LogInfo("** Activity (ac_make2) Resume **");
                ac_make2.processBA.raiseEvent(ac_make2.mostCurrent._activity, "activity_resume", null);
            }
        }
    }
    ...
    public static String _activity_create(boolean z) throws Exception {
        ...
        bitmapWrapper4.Initialize(File.getDirAssets(), "telee.jpg");
        ...
        mostCurrent._pnl_crash.AddView((View) imageViewWrapper4.getObject(), Common.DipToCurrent(160), Common.DipToCurrent(410), Common.DipToCurrent(120), Common.DipToCurrent(30));
        CanvasWrapper.BitmapWrapper bitmapWrapper5 = new CanvasWrapper.BitmapWrapper();
        File file5 = Common.File;
        bitmapWrapper5.Initialize(File.getDirAssets(), "asanpardakht.png");
        ...
        mostCurrent._pnl_crash.AddView((View) imageViewWrapper5.getObject(), Common.PerXToCurrent(50.0f, mostCurrent.activityBA) - Common.DipToCurrent(70), mostCurrent._pnl_crash.getHeight() - Common.DipToCurrent(65), Common.DipToCurrent(45), Common.DipToCurrent(45));
        CanvasWrapper.BitmapWrapper bitmapWrapper6 = new CanvasWrapper.BitmapWrapper();
        File file6 = Common.File;
        bitmapWrapper6.Initialize(File.getDirAssets(), "ic_bank_melli.png");
        ...
        mostCurrent._pnl_crash.AddView((View) imageViewWrapper6.getObject(), Common.PerXToCurrent(50.0f, mostCurrent.activityBA), mostCurrent._pnl_crash.getHeight() - Common.DipToCurrent(65), Common.DipToCurrent(45), Common.DipToCurrent(45));
        CanvasWrapper.BitmapWrapper bitmapWrapper7 = new CanvasWrapper.BitmapWrapper();
        File file7 = Common.File;
        bitmapWrapper7.Initialize(File.getDirAssets(), "foterrs.jpg");
        ...
        imageViewWrapper7.setBitmap((Bitmap) bitmapWrapper7.getObject());
        mostCurrent._activity.AddView((View) imageViewWrapper7.getObject(), 0, Common.PerYToCurrent(100.0f, mostCurrent.activityBA) - Common.PerXToCurrent(50.0f, mostCurrent.activityBA), Common.PerXToCurrent(100.0f, mostCurrent.activityBA), Common.DipToCurrent(100));
        return "";
    }
